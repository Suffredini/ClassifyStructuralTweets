...
public class FeaturesExtractor {
    ...
    public static String[] deleteUrlAndPic(String[] tweets){
    ...
    public static List<List<String>> tokenization(String[] tweets){
    ...
    public static List<List<String>> stopWordFiltering(List<String> stopWords, List<List<String>> tokenized){
    ...
    public static List<List<String>> stemming(List<String[]> stemmingList, List<List<String>> tweetsNoStopWord){
    ...
    public static Map<String, Double> computeSumWeight(List<List<String>> tweetsStemmed,  int numberTweets) {
    ...
    public static List<String[]> completeSetOfStems(List<List<String>> tweetsStemmed, Map<String, Double> weightedSum, String[] classes){
    ...
    public static String[] extractAllAttributes(List<List<String>> tweetsStemmed) {
    ...
    public static List<String[]> getArrayAllTweets(String[] allAttributes, String[] classes, List<List<String>> tweetsStemmed) {
